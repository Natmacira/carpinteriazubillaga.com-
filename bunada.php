    ...
    <header>
        <section class="principal-header-section">
            <a href="index.html"><picture>
				<!-- Desktop -->
				<source media="(min-width:1200px)" srcset="img/desktop/logo-web.svg" alt="Logo Carpinteria Zubillaga">
				<!-- Mobile  -->
            ...
            <div id="container" class="open clss">
                ...
                <span>
                    <ul class="sub-menu ">
                        <li>
                            <a href="#about" title="about">DESDE 1890</a></figcaption>
                        </li>
                        <li>
                            <a href="#skills" title="skills">PUERTAS NOBLES</a></figcaption>
                        </li>
                        <li>
                            <a href="#jobs" title="jobs">VIDEO</a></figcaption>
                        </li>
                        <li>
                            <a href="#contact" title="contact">CONTACTO</a></figcaption>
                        </li>
                    </ul>
                </span>
                <span class="cls"></span>
