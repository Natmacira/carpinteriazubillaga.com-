...
?>
        <section class="door-presentation">
            <picture>
                <!-- Desktop -->
                <source media="(min-width:768px)" srcset="img/pantografiada/desktop_pantografiada_portada.png"
                    alt="Logo Carpinteria Zubillaga">
                <!-- Mobile  -->
                <img src="img/pantografiada/mobile_pantografiada_portada.png" alt="">
            </picture>
            <h1>Pantografiada</h1>
        </section>
        ...
        <section class="swiper generic-swiper">
            <div class="swiper-wrapper">
                ...
                <article class="swiper-slide">
                    ...
                    <picture>
                        <!-- Desktop -->
                        <source media="(min-width:1200px)" srcset="img/pantografiada/desktop_pantografiada_carrusel1.jpg"
                            alt="Logo Carpinteria Zubillaga">
                        <!-- Mobile  -->
                ...
                <article class="swiper-slide">
                    ...
                    <picture>
                        <!-- Desktop -->
                        <source media="(min-width:1200px)" srcset="img/pantografiada/desktop_pantografiada_carrusel2.jpg"
                            alt="Logo Carpinteria Zubillaga">
                        <!-- Mobile  -->
